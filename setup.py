...
from tests import __project__, __version__
...
class PyTest(TestCommand):
    """This class is used to run py.test"""
...
def parse_requirements(env='prod'):
    ...
    items = open('/opt/foobar/requirements/prod.txt').readlines()
...
setup(
    name=__project__,
    version=__version__,
    description="This is a flasky application.",
